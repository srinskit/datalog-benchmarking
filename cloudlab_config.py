...
bench_os_image = (
    "urn:publicid:IDN+clemson.cloudlab.us+image+lpad-PG0:dlbench-ubu20-v4.0"
)
...
if params.benchNodeType != "":
    ...
    if len(tokens) != 1:
        pc.reportError(
            portal.ParameterError("Only a single type is allowed", ["benchNodeType"])
        )
...
for i in range(params.nodeCount):
    ...
    # Add to lan
    lan.addInterface(node.addInterface("eth1"))
